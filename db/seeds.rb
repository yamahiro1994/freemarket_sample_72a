...
toygoods_child_array = ['おもちゃ','タレントグッズ','コミック/アニメグッズ','トレーディングカード','フィギュア','楽器/器材','コレクション','ミリタリー','美術品','アート用品','その他']
toygoods_grandchild_array = [
...
toygoods_child_array.each_with_index do |child, i|
  child = parent.children.create(name: child)
  toygoods_grandchild_array[i].each do |grandchild|
    child.children.create(name: grandchild)
  end
end

perfume_child_array = ['ベースメイク','メイクアップ','ネイルケア','香水','スキンケア/基礎化粧品','ヘアケア','ボディケア','オーラルケア','リラクゼーション','ダイエット','その他']
perfume_grandchild_array = [
...
perfume_child_array.each_with_index do |child, i|
  child = parent.children.create(name: child)
  perfume_grandchild_array[i].each do |grandchild|
    child.children.create(name: grandchild)
  end
end

homeppiliances_child_array = ['スマートフォン/携帯電話','スマホアクセサリー','PC/タブレット','カメラ','テレビ/映像機器','オーディオ機器','美容/健康','冷暖房/空調','生活家電','その他']
homeppiliances_grandchild_array = [
...
homeppiliances_child_array.each_with_index do |child, i|
  child = parent.children.create(name: child)
  homeppiliances_grandchild_array[i].each do |grandchild|
    child.children.create(name: grandchild)
  end
end
...
other_grandchild_array = [
                           ...
                           ['菓子','米','野菜','果物','調味料','魚介類(加工食品)','肉類(加工食品)','その他'], 
